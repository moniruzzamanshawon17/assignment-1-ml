...
```bash
git clone https://github.com/moniruzzamanshawon17/assignment-1-ml.git
cd assignment-1-ml
```
...
**Programming route** -- `RunnableBranch` selects the programming specialist
 
![Programming route](assets/programming.png)
 
**Math route** -- the same pipeline routed to the math tutor
 
![Math route](assets/math.png)
 
**General route** -- default branch, showing the full structured output
 
![General route](assets/general.png)
